...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		void ScaleCapsuleForCrouching(bool crouch)
		{
			...
			{
				Ray crouchRay = new Ray(m_Rigidbody.position + transform.position.normalized * m_Capsule.radius * k_Half, transform.position.normalized);
		...
		void HandleAirborneMovement()
		{
            ...
            // f(a,b) = ab - a >> f(a,b) = a(b-1)
            Vector3 extraGravityForce = transform.up.normalized * -9.81f * (m_GravityMultiplier - 1);
